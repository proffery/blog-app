 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class KC{constructor(e,n){this.name=e,this.container=n,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(e){const n=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(n)){const r=new OC;if(this.instancesDeferred.set(n,r),this.isInitialized(n)||this.shouldAutoInitialize())try{const i=this.getOrInitializeService({instanceIdentifier:n});i&&r.resolve(i)}catch{}}return this.instancesDeferred.get(n).promise}getImmediate(e){var n;const r=this.normalizeInstanceIdentifier(e==null?void 0:e.identifier),i=(n=e==null?void 0:e.optional)!==null&&n!==void 0?n:!1;if(this.isInitialized(r)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:r})}catch(s){if(i)return null;throw s}else{if(i)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(e){if(e.name!==this.name)throw Error(`Mismatching Component ${e.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=e,!!this.shouldAutoInitialize()){if(QC(e))try{this.getOrInitializeService({instanceIdentifier:Rr})}catch{}for(const[n,r]of this.instancesDeferred.entries()){const i=this.normalizeInstanceIdentifier(n);try{const s=this.getOrInitializeService({instanceIdentifier:i});r.resolve(s)}catch{}}}}clearInstance(e=Rr){this.instancesDeferred.delete(e),this.instancesOptions.delete(e),this.instances.delete(e)}async delete(){const e=Array.from(this.instances.values());await Promise.all([...e.filter(n=>"INTERNAL"in n).map(n=>n.INTERNAL.delete()),...e.filter(n=>"_delete"in n).map(n=>n._delete())])}isComponentSet(){return this.component!=null}isInitialized(e=Rr){return this.instances.has(e)}getOptions(e=Rr){return this.instancesOptions.get(e)||{}}initialize(e={}){const{options:n={}}=e,r=this.normalizeInstanceIdentifier(e.instanceIdentifier);if(this.isInitialized(r))throw Error(`${this.name}(${r}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const i=this.getOrInitializeService({instanceIdentifier:r,options:n});for(const[s,o]of this.instancesDeferred.entries()){const a=this.normalizeInstanceIdentifier(s);r===a&&o.resolve(i)}return i}onInit(e,n){var r;const i=this.normalizeInstanceIdentifier(n),s=(r=this.onInitCallbacks.get(i))!==null&&r!==void 0?r:new Set;s.add(e),this.onInitCallbacks.set(i,s);const o=this.instances.get(i);return o&&e(o,i),()=>{s.delete(e)}}invokeOnInitCallbacks(e,n){const r=this.onInitCallbacks.get(n);if(r)for(const i of r)try{i(e,n)}catch{}}getOrInitializeService({instanceIdentifier:e,options:n={}}){let r=this.instances.get(e);if(!r&&this.component&&(r=this.component.instanceFactory(this.container,{instanceIdentifier:GC(e),options:n}),this.instances.set(e,r),this.instancesOptions.set(e,n),this.invokeOnInitCallbacks(r,e),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,e,r)}catch{}return r||null}normalizeInstanceIdentifier(e=Rr){return this.component?this.component.multipleInstances?e:Rr:e}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function GC(t){return t===Rr?void 0:t}function QC(t){return t.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xl=new Map,Id=new Map;function Fx(t,e){try{t.container.addComponent(e)}catch(n){Wr.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function Kr(t){const e=t.name;if(Id.has(e))return Wr.debug(`There were multiple attempts to register component ${e}.`),!1;Id.set(e,t);for(const n of Xl.values())Fx(n,t);return!0}function Fu(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jl=new hp("@firebase/auth");function Zx(t,...e){Jl.logLevel<=Z.WARN&&Jl.warn(`Auth (${oi}): ${t}`,...e)}function fl(t,...e){Jl.logLevel<=Z.ERROR&&Jl.error(`Auth (${oi}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ih(t,e){return ta(t,"POST","/v1/accounts:signInWithPassword",ds(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function DR(t,e){return ta(t,"POST","/v1/accounts:signInWithEmailLink",ds(t,e))}async function bR(t,e){return ta(t,"POST","/v1/accounts:signInWithEmailLink",ds(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vi(t,e){return ta(t,"POST","/v1/accounts:signInWithIdp",ds(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ps{constructor(){this.providerId=ps.PROVIDER_ID}static credential(e,n){return xo._fromEmailAndPassword(e,n)}static credentialWithLink(e,n){const r=Ep.parseLink(n);return V(r,"argument-error"),xo._fromEmailAndCode(e,r.code,r.tenantId)}}ps.PROVIDER_ID="password";ps.EMAIL_PASSWORD_SIGN_IN_METHOD="password";ps.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn extends na{constructor(){super("github.com")}static credential(e){return Gr._fromParams({providerId:zn.PROVIDER_ID,signInMethod:zn.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return zn.credentialFromTaggedObject(e)}static credentialFromError(e){return zn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return zn.credential(e.oauthAccessToken)}catch{return null}}}zn.GITHUB_SIGN_IN_METHOD="github.com";zn.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function sh(t,e){return ta(t,"POST","/v1/accounts:signUp",ds(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jR(t,e,n=!1){const{auth:r}=t,i="reauthenticate";try{const s=await ko(t,O1(r,i,e,t),n);V(s.idToken,r,"internal-error");const o=vp(s.idToken);V(o,r,"internal-error");const{sub:a}=o;return V(t.uid===a,r,"user-mismatch"),Qr._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&Mt(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ZN(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function eP(t){Kr(new hr("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=r.options;V(o&&!o.includes(":"),"invalid-api-key",{appName:r.name});const l={apiKey:o,authDomain:a,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:C1(t)},u=new CR(r,i,s,l);return RR(u,n),u},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),Kr(new hr("auth-internal",e=>{const n=ai(e.getProvider("auth").getImmediate());return(r=>new JN(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),ln(Ey,Sy,ZN(t)),ln(Ey,Sy,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yr=new hp("@firebase/firestore");function Fy(){return Yr.logLevel}function M(t,...e){if(Yr.logLevel<=Z.DEBUG){const n=e.map(Kp);Yr.debug(`Firestore (${ys}): ${t}`,...n)}}function Pn(t,...e){if(Yr.logLevel<=Z.ERROR){const n=e.map(Kp);Yr.error(`Firestore (${ys}): ${t}`,...n)}}function ts(t,...e){if(Yr.logLevel<=Z.WARN){const n=e.map(Kp);Yr.warn(`Firestore (${ys}): ${t}`,...n)}}function Kp(t){if(typeof t=="string")return t;try{return e=t,JSON.stringify(e)}catch{return t}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Q_{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class BA{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable(()=>n(Xe.UNAUTHENTICATED))}shutdown(){}}class zA{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,n){this.changeListener=n,e.enqueueRetryable(()=>n(this.token.user))}shutdown(){this.changeListener=null}}class HA{constructor(e){this.t=e,this.currentUser=Xe.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){let r=this.i;const i=l=>this.i!==r?(r=this.i,n(l)):Promise.resolve();let s=new ar;this.o=()=>{this.i++,this.currentUser=this.u(),s.resolve(),s=new ar,e.enqueueRetryable(()=>i(this.currentUser))};const o=()=>{const l=s;e.enqueueRetryable(async()=>{await l.promise,await i(this.currentUser)})},a=l=>{M("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=l,this.auth.addAuthTokenListener(this.o),o()};this.t.onInit(l=>a(l)),setTimeout(()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?a(l):(M("FirebaseAuthCredentialsProvider","Auth not yet detected"),s.resolve(),s=new ar)}},0),o()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(r=>this.i!==e?(M("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(le(typeof r.accessToken=="string"),new Q_(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const e=this.auth&&this.auth.getUid();return le(e===null||typeof e=="string"),new Xe(e)}}class qA{constructor(e,n,r){this.h=e,this.l=n,this.m=r,this.type="FirstParty",this.user=Xe.FIRST_PARTY,this.g=new Map}p(){return this.m?this.m():null}get headers(){this.g.set("X-Goog-AuthUser",this.h);const e=this.p();return e&&this.g.set("Authorization",e),this.l&&this.g.set("X-Goog-Iam-Authorization-Token",this.l),this.g}}class WA{constructor(e,n,r){this.h=e,this.l=n,this.m=r}getToken(){return Promise.resolve(new qA(this.h,this.l,this.m))}start(e,n){e.enqueueRetryable(()=>n(Xe.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class KA{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class GA{constructor(e){this.I=e,this.forceRefresh=!1,this.appCheck=null,this.T=null}start(e,n){const r=s=>{s.error!=null&&M("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${s.error.message}`);const o=s.token!==this.T;return this.T=s.token,M("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?n(s.token):Promise.resolve()};this.o=s=>{e.enqueueRetryable(()=>r(s))};const i=s=>{M("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=s,this.appCheck.addTokenListener(this.o)};this.I.onInit(s=>i(s)),setTimeout(()=>{if(!this.appCheck){const s=this.I.getImmediate({optional:!0});s?i(s):M("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(n=>n?(le(typeof n.token=="string"),this.T=n.token,new KA(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fa(t){if(t.code!==C.FAILED_PRECONDITION||t.message!==e2)throw t;M("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gp{constructor(e,n){this.previousValue=e,n&&(n.sequenceNumberHandler=r=>this.ot(r),this.ut=r=>n.writeSequenceNumber(r))}ot(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.ut&&this.ut(e),e}}Gp.ct=-1;function sc(t){return t==null}function du(t){return t===0&&1/t==-1/0}function n2(t){return typeof t=="number"&&Number.isInteger(t)&&!du(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vy(t){let e=0;for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e++;return e}function ui(t,e){for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e(n,t[n])}function X_(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ot{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(r){try{return atob(r)}catch(i){throw typeof DOMException<"u"&&i instanceof DOMException?new J_("Invalid base64 string: "+i):i}}(e);return new ot(n)}static fromUint8Array(e){const n=function(r){let i="";for(let s=0;s<r.length;++s)i+=String.fromCharCode(r[s]);return i}(e);return new ot(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return e=this.binaryString,btoa(e);var e}toUint8Array(){return function(e){const n=new Uint8Array(e.length);for(let r=0;r<e.length;r++)n[r]=e.charCodeAt(r);return n}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return ee(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}ot.EMPTY_BYTE_STRING=new ot("");const r2=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function fr(t){if(le(!!t),typeof t=="string"){let e=0;const n=r2.exec(t);if(le(!!n),n[1]){let i=n[1];i=(i+"000000000").substr(0,9),e=Number(i)}const r=new Date(t);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:ke(t.seconds),nanos:ke(t.nanos)}}function ke(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function Xr(t){return typeof t=="string"?ot.fromBase64String(t):ot.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hi{constructor(e,n="asc"){this.field=e,this.dir=n}}function o2(t,e){return t.dir===e.dir&&t.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ws{constructor(e,n){this.mapKeyFn=e,this.equalsFn=n,this.inner={},this.innerSize=0}get(e){const n=this.mapKeyFn(e),r=this.inner[n];if(r!==void 0){for(const[i,s]of r)if(this.equalsFn(i,e))return s}}has(e){return this.get(e)!==void 0}set(e,n){const r=this.mapKeyFn(e),i=this.inner[r];if(i===void 0)return this.inner[r]=[[e,n]],void this.innerSize++;for(let s=0;s<i.length;s++)if(this.equalsFn(i[s][0],e))return void(i[s]=[e,n]);i.push([e,n]),this.innerSize++}delete(e){const n=this.mapKeyFn(e),r=this.inner[n];if(r===void 0)return!1;for(let i=0;i<r.length;i++)if(this.equalsFn(r[i][0],e))return r.length===1?delete this.inner[n]:r.splice(i,1),this.innerSize--,!0;return!1}forEach(e){ui(this.inner,(n,r)=>{for(const[i,s]of r)e(i,s)})}isEmpty(){return X_(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const w2=new ge(U.comparator);function On(){return w2}const cE=new ge(U.comparator);function Vs(...t){let e=cE;for(const n of t)e=e.insert(n.key,n);return e}function hE(t){let e=cE;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function Lr(){return to()}function dE(){return to()}function to(){return new ws(t=>t.toString(),(t,e)=>t.isEqual(e))}const _2=new ge(U.comparator),E2=new rt(U.comparator);function G(...t){let e=E2;for(const n of t)e=e.add(n);return e}const S2=new rt(ee);function T2(){return S2}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fE(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:du(e)?"-0":e}}function pE(t){return{integerValue:""+t}}function I2(t,e){return n2(e)?pE(e):fE(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const U2=new zi([4294967295,4294967295],0);function tv(t){const e=M2().encode(t),n=new VA;return n.update(e),new Uint8Array(n.digest())}function nv(t){const e=new DataView(t.buffer),n=e.getUint32(0,!0),r=e.getUint32(4,!0),i=e.getUint32(8,!0),s=e.getUint32(12,!0);return[new zi([n,r],0),new zi([i,s],0)]}class im{constructor(e,n,r){if(this.bitmap=e,this.padding=n,this.hashCount=r,n<0||n>=8)throw new Bs(`Invalid padding: ${n}`);if(r<0)throw new Bs(`Invalid hash count: ${r}`);if(e.length>0&&this.hashCount===0)throw new Bs(`Invalid hash count: ${r}`);if(e.length===0&&n!==0)throw new Bs(`Invalid padding when bitmap length is 0: ${n}`);this.It=8*e.length-n,this.Tt=zi.fromNumber(this.It)}Et(e,n,r){let i=e.add(n.multiply(zi.fromNumber(r)));return i.compare(U2)===1&&(i=new zi([i.getBits(0),i.getBits(1)],0)),i.modulo(this.Tt).toNumber()}At(e){return(this.bitmap[Math.floor(e/8)]&1<<e%8)!=0}vt(e){if(this.It===0)return!1;const n=tv(e),[r,i]=nv(n);for(let s=0;s<this.hashCount;s++){const o=this.Et(r,i,s);if(!this.At(o))return!1}return!0}static create(e,n,r){const i=e%8==0?0:8-e%8,s=new Uint8Array(Math.ceil(e/8)),o=new im(s,i,n);return r.forEach(a=>o.insert(a)),o}insert(e){if(this.It===0)return;const n=tv(e),[r,i]=nv(n);for(let s=0;s<this.hashCount;s++){const o=this.Et(r,i,s);this.Rt(o)}}Rt(e){const n=Math.floor(e/8),r=e%8;this.bitmap[n]|=1<<r}}class Bs extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rO{constructor(e){this.fe=e}}function iO(t){const e=X2({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?Hd(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dc(t){return new z2(t,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+s.stack),o}(r);throw Pn("INTERNAL UNHANDLED ERROR: ",i),r}).then(r=>(this.Hc=!1,r))));return this.Gc=n,n}enqueueAfterDelay(e,n,r){this.Zc(),this.Yc.indexOf(e)>-1&&(n=0);const i=dm.createAndSchedule(this,e,n,r,s=>this.na(s));return this.zc.push(i),i}Zc(){this.Wc&&B()}verifyOperationInProgress(){}async sa(){let e;do e=this.Gc,await e;while(e!==this.Gc)}ia(e){for(const n of this.zc)if(n.timerId===e)return!0;return!1}ra(e){return this.sa().then(()=>{this.zc.sort((n,r)=>n.targetTimeMs-r.targetTimeMs);for(const n of this.zc)if(n.skipDelay(),e!=="all"&&n.timerId===e)break;return this.sa()})}oa(e){this.Yc.push(e)}na(e){const n=this.zc.indexOf(e);this.zc.splice(n,1)}}class _a extends gc{constructor(e,n,r,i){super(e,n,r,i),this.type="firestore",this._queue=new CD,this._persistenceKey=(i==null?void 0:i.name)||"[DEFAULT]"}_terminate(){return this._firestoreClient||JE(this),this._firestoreClient.terminate()}}function Zr(t,e){const n=typeof t=="object"?t:pp(),r=typeof t=="string"?t:e||"(default)",i=Fu(n,"firestore").getImmediate({identifier:r});if(!i._initialized){const s=r1("firestore");s&&kD(i,...s)}return i}function XE(t){return t._firestoreClient||JE(t),t._firestoreClient.verifyNotTerminated(),t._firestoreClient}function JE(t){var e,n,r;const i=t._freezeSettings(),s=function(o,a,l,u){return new i2(o,a,l,u.host,u.ssl,u.experimentalForceLongPolling,u.experimentalAutoDetectLongPolling,GE(u.experimentalLongPollingOptions),u.useFetchStreams)}(t._databaseId,((e=t._app)===null||e===void 0?void 0:e.options.appId)||"",t._persistenceKey,i);t._firestoreClient=new vD(t._authCredentials,t._appCheckCredentials,t._queue,s),!((n=i.cache)===null||n===void 0)&&n._offlineComponentProvider&&(!((r=i.cache)===null||r===void 0)&&r._onlineComponentProvider)&&(t._firestoreClient._uninitializedComponentsProvider={_offlineKind:i.cache.kind,_offline:i.cache._offlineComponentProvider,_online:i.cache._onlineComponentProvider})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
  ...
  `),f[w]}function s(){var c=arguments.length>0&&arguments[0]!==void 0?arguments[0]:u.defaults,d=c.children,m=(c.out,c.forever),y=c.timeout,S=c.duration,g=S===void 0?u.defaults.duration:S,p=c.delay,v=p===void 0?u.defaults.delay:p,_=c.count,k=_===void 0?u.defaults.count:_,w=r(c,["children","out","forever","timeout","duration","delay","count"]),T={make:i,duration:y===void 0?g:y,delay:v,forever:m,count:k,style:{animationFillMode:"both"}};return(0,l.default)(w,T,T,d)}Object.defineProperty(e,"__esModule",{value:!0});var o=pn,a=bn,l=n(a),u=Qt,h={out:o.bool,left:o.bool,right:o.bool,top:o.bool,bottom:o.bool,mirror:o.bool,opposite:o.bool,duration:o.number,timeout:o.number,delay:o.number,count:o.number,forever:o.bool},f={};s.propTypes=h,e.default=s,t.exports=e.default})(cf,cf.exports);var y$=cf.exports,hf={exports:{}};(function(t,e){function n(c){return c&&c.__esModule?c:{default:c}}function r(c,d){var m={};for(var y in c)d.indexOf(y)>=0||Object.prototype.hasOwnProperty.call(c,y)&&(m[y]=c[y]);return m}function i(c,d){var m=d.left,y=d.right,S=d.mirror,g=d.opposite,p=(m?1:0)|(y?2:0)|(S?16:0)|(g?32:0)|(c?64:0);if(f.hasOwnProperty(p))return f[p];if(!S!=!(c&&g)){var v=[y,m];m=v[0],y=v[1]}var _=m?"-100%":y?"100%":"0",k=c?`from {
    ...
    `:`from {
      ...
      to {
        ...
        }`):O=(c?"to":"from")+" {opacity: 0; transform: scale3d(.1, .1, .1);} "+(c?"from":"to")+" { opacity: 1; transform: none;}",f[w]=(0,u.animation)(O),f[w]}function s(){var c=arguments.length>0&&arguments[0]!==void 0?arguments[0]:u.defaults,d=c.children,m=(c.out,c.forever),y=c.timeout,S=c.duration,g=S===void 0?u.defaults.duration:S,p=c.delay,v=p===void 0?u.defaults.delay:p,_=c.count,k=_===void 0?u.defaults.count:_,w=r(c,["children","out","forever","timeout","duration","delay","count"]),T={make:i,duration:y===void 0?g:y,delay:v,forever:m,count:k,style:{animationFillMode:"both"},reverse:w.left};return(0,l.default)(w,T,T,d)}Object.defineProperty(e,"__esModule",{value:!0});var o=pn,a=bn,l=n(a),u=Qt,h={out:o.bool,left:o.bool,right:o.bool,top:o.bool,bottom:o.bool,mirror:o.bool,opposite:o.bool,duration:o.number,timeout:o.number,delay:o.number,count:o.number,forever:o.bool},f={};s.propTypes=h,e.default=s,t.exports=e.default})(df,df.exports);var w$=df.exports;(function(t){function e(f){return f&&f.__esModule?f:{default:f}}Object.defineProperty(t,"__esModule",{value:!0});var n=d$;Object.defineProperty(t,"default",{enumerable:!0,get:function(){return e(n).default}});var r=Lm;Object.defineProperty(t,"Fade",{enumerable:!0,get:function(){return e(r).default}});var i=f$;Object.defineProperty(t,"Bounce",{enumerable:!0,get:function(){return e(i).default}});var s=p$;Object.defineProperty(t,"Roll",{enumerable:!0,get:function(){return e(s).default}});var o=m$;Object.defineProperty(t,"Slide",{enumerable:!0,get:function(){return e(o).default}});var a=g$;Object.defineProperty(t,"Flip",{enumerable:!0,get:function(){return e(a).default}}),Object.defineProperty(t,"Reveal",{enumerable:!0,get:function(){return e(n).default}});var l=y$;Object.defineProperty(t,"Rotate",{enumerable:!0,get:function(){return e(l).default}});var u=v$;Object.defineProperty(t,"LightSpeed",{enumerable:!0,get:function(){return e(u).default}});var h=w$;Object.defineProperty(t,"Zoom",{enumerable:!0,get:function(){return e(h).default}})})(_u);const _$=t=>{const e=i=>{t.deletePost(i),t.refreshPage()},n=()=>{t.refreshPage()},r=i=>{t.showError(i)};return E.jsxs("div",{className:Th.container,children:[E.jsx("h1",{className:Th.header,children:"All blog posts"}),t.posts.map(i=>E.jsx("div",{className:Th.post,children:E.jsx(_u.Slide,{bottom:!0,children:E.jsx(wu,{postData:i,isOpened:!1,readMoreVisibility:!0,refreshPage:n,deletePost:e,showError:r})})},i.id))]})},E$="_container_2amsk_1",S$="_post_2amsk_17",T$="_header_2amsk_25",Nv={container:E$,post:S$,header:T$},I$=t=>{const{id:e}=bk(),n=s=>{t.deletePost(s),t.refreshPage()},r=()=>{t.refreshPage()},i=s=>{t.showError(s)};return E.jsx("div",{className:Nv.container,children:t.posts.filter(s=>s.id===e).map(s=>E.jsx("div",{className:Nv.post,children:E.jsx(wu,{postData:s,isOpened:!0,readMoreVisibility:!0,refreshPage:r,deletePost:n,showError:i})},s.timestamp))})},k$="_container_svpzy_1",C$="_header_svpzy_19",x$="_vertical_svpzy_35",R$="_horisontal_svpzy_55",N$="_lastPost_svpzy_73",P$="_lastThreePosts_svpzy_93",A$="_postImageHolder_svpzy_113",O$="_lastPostImage_svpzy_125",D$="_lastThreePostImage_svpzy_137",b$="_content_svpzy_149",L$="_userInfo_svpzy_167",$$="_userName_svpzy_187",M$="_img_svpzy_201",ce={container:k$,header:C$,vertical:x$,horisontal:R$,lastPost:N$,lastThreePosts:P$,postImageHolder:A$,lastPostImage:O$,lastThreePostImage:D$,content:b$,userInfo:L$,userName:$$,img:M$},U$=t=>{const e=i=>{t.deletePost(i),t.refreshPage()},n=()=>{t.refreshPage()},r=i=>{t.showError(i)};return E.jsxs("div",{className:ce.container,children:[E.jsx("h1",{className:ce.header,children:"Recent posts"}),t.posts.length>0?E.jsx(_u.Flip,{left:!0,children:E.jsx(wu,{postData:t.posts[0],isOpened:!1,readMoreVisibility:!1,refreshPage:n,deletePost:e,showError:r})}):E.jsx("div",{children:"No posts yet"}),t.posts.length>1&&E.jsx(_u.Bounce,{right:!0,cascade:!0,children:E.jsxs("div",{className:ce.lastThreePosts,children:[E.jsxs("div",{className:ce.horisontal,children:[t.posts[1].image_url!==""&&E.jsx("div",{className:ce.postImageHolder,children:E.jsx("img",{className:ce.lastThreePostImage,src:t.posts[1].image_url,alt:"Post image"})}),E.jsxs("div",{className:ce.vertical,children:[E.jsxs("div",{children:[E.jsx("h2",{className:ce.title,children:E.jsxs(ji,{to:"/posts/"+t.posts[1].id,children:[t.posts[1].title,"↗"]})}),E.jsx("p",{className:ce.content,children:t.posts[1].text})]}),E.jsxs("div",{className:ce.userInfo,children:["Posted"," "+new Date(t.posts[1].timestamp.seconds*1e3).toLocaleString("ru-RU",{dateStyle:"short"})+", "+new Date(t.posts[1].timestamp.seconds*1e3).toLocaleTimeString("ru-Ru")+" "]})]})]}),t.posts.length>2&&E.jsxs("div",{className:ce.horisontal,children:[t.posts[2].image_url!==""&&E.jsx("div",{className:ce.postImageHolder,children:E.jsx("img",{className:ce.lastThreePostImage,src:t.posts[2].image_url,alt:"Post image"})}),E.jsxs("div",{className:ce.vertical,children:[E.jsxs("div",{children:[E.jsx("h2",{className:ce.title,children:E.jsxs(ji,{to:"/posts/"+t.posts[2].id,children:[t.posts[2].title,"↗"]})}),E.jsx("p",{className:ce.content,children:t.posts[2].text})]}),E.jsxs("div",{className:ce.userInfo,children:["Posted"," "+new Date(t.posts[2].timestamp.seconds*1e3).toLocaleString("ru-RU",{dateStyle:"short"})+", "+new Date(t.posts[2].timestamp.seconds*1e3).toLocaleTimeString("ru-Ru")+" "]})]})]}),t.posts.length>3&&E.jsxs("div",{className:ce.horisontal,children:[t.posts[3].image_url!==""&&E.jsx("div",{className:ce.postImageHolder,children:E.jsx("img",{className:ce.lastThreePostImage,src:t.posts[3].image_url,alt:"Post image"})}),E.jsxs("div",{className:ce.vertical,children:[E.jsxs("div",{children:[E.jsx("h2",{className:ce.title,children:E.jsxs(ji,{to:"/posts/"+t.posts[3].id,children:[t.posts[3].title,"↗"]})}),E.jsx("p",{className:ce.content,children:t.posts[3].text})]}),E.jsxs("div",{className:ce.userInfo,children:["Posted"," "+new Date(t.posts[3].timestamp.seconds*1e3).toLocaleString("ru-RU",{dateStyle:"short"})+", "+new Date(t.posts[3].timestamp.seconds*1e3).toLocaleTimeString("ru-Ru")+" "]})]})]})]})}),t.posts.map((i,s)=>s>=4&&s<6&&E.jsx(wu,{postData:i,isOpened:!1,readMoreVisibility:!1,refreshPage:n,deletePost:e,showError:r},i.id))]})},j$="_container_1yb8a_1",F$="_header_1yb8a_19",V$="_paragraph_1yb8a_33",yi={container:j$,header:F$,paragraph:V$},B$=()=>E.jsxs("div",{className:yi.container,children:[E.jsx("h1",{className:yi.header,children:"About"}),E.jsx("p",{className:yi.paragraph,children:"Currently, the blog is running in DEMO mode, which means any user who logged in using email or Google can write a post. However, in the release version, only users with email addresses from the approved list can create posts. Adding comments is open to any logged-in user, regardless of whether the blog is in DEMO mode or not. Both registered and non-registered users can read posts and comments."}),E.jsx("p",{className:yi.paragraph,children:"Welcome to our blog! We aim to create a platform where users can share their thoughts and insights freely. Whether you are an authorized user or just passing by, we encourage you to explore and engage with the content shared by our community. Please note that during DEMO mode, posting is unrestricted, but this will change in the final release to ensure a secure and trusted environment."}),E.jsxs("p",{className:yi.paragraph,children:["We appreciate your support and feedback as we continue to develop and improve this blog. If you have any questions or suggestions, feel free to reach out to us at ",E.jsx("a",{href:"mailto:proffery@gmail.com",children:"proffery@gmail.com"}),"."]}),E.jsx("p",{className:yi.paragraph,children:"Happy reading and writing!"})]}),z$=t=>{const[e,n]=x.useState(t.user===null?!1:!!t.user.auth.currentUser),[r,i]=x.useState("hidden"),[s,o]=x.useState(""),[a,l]=x.useState(!1),[u,h]=x.useState("userBarHidden"),[f,c]=x.useState("linksHidden"),d=()=>{t.authStateChanged()},m=v=>{i("visible"),o(v),setTimeout(()=>i("hidden"),2e3)},y=()=>{h(u==="userBarHidden"?"userBarActive":"userBarHidden"),c(f==="linksHidden"?"linksActive":"linksHidden")},S=v=>{t.deletePost(v)},g=()=>{l(!a)},p=()=>{t.refreshPage()};return E.jsxs(eC,{children:[E.jsxs("div",{className:Ge.container,children:[e?E.jsx(Rv,{top:!0,when:u==="userBarActive",children:E.jsx("div",{className:Ge.logout+" "+u,children:E.jsx(cP,{prop:t.user,isAdmin:a,authStateChanged:d})})}):E.jsx(Rv,{top:!0,when:u==="userBarActive",children:E.jsxs("div",{className:Ge.login+" "+u,children:[E.jsx(iP,{prop:t.user,authStateChanged:d,showError:m}),E.jsxs("div",{className:Ge.register,children:[E.jsx("em",{children:"Don’t have an account? Register"}),E.jsx(Ns,{to:"/register",children:"here"})]})]})}),E.jsx("div",{className:Ge.error,style:{visibility:r},children:s}),E.jsxs("nav",{children:[E.jsxs("ul",{className:Ge.links+" "+f,children:[E.jsx("li",{children:E.jsx(Ns,{to:"/",children:"Home"})}),E.jsx("li",{children:E.jsx(Ns,{to:"/posts",children:"Posts"})}),E.jsx("li",{children:E.jsx(Ns,{to:"/about",children:"About"})}),a&&E.jsx("li",{children:E.jsx(Ns,{to:"/newpost",children:"New"})}),e&&E.jsx("li",{children:E.jsxs("div",{className:Ge.demo,children:[E.jsx("label",{htmlFor:"demo",children:"DEMO"}),E.jsxs("label",{className:Ge.switch,children:[E.jsx("input",{className:Ge.slider+"-input",id:"demo",type:"checkbox",checked:a,onChange:g}),E.jsx("span",{className:Ge.slider+" "+Ge.round})]})]})}),E.jsx("li",{children:E.jsx("h1",{className:Ge.empty})})]}),E.jsx("div",{className:Ge.userStatus,onClick:y,children:e?E.jsxs(E.Fragment,{children:[E.jsx("img",{src:Le().currentUser.photoURL||"./img/account-outline.svg",alt:"User slider",className:Ge.userImg}),E.jsx("p",{className:Ge.userEmail,children:t.user.auth.currentUser.email})]}):E.jsx(E.Fragment,{children:E.jsx("p",{className:Ge.userLogin,children:"Log in"})})})]})]}),E.jsxs(Gk,{children:[E.jsx(Mn,{path:"/",element:E.jsx(U$,{posts:t.posts,deletePost:S,refreshPage:p,showError:m})}),E.jsx(Mn,{path:"/posts",element:E.jsx(_$,{posts:t.posts,deletePost:S,refreshPage:p,showError:m})}),E.jsx(Mn,{path:"/posts/:id",element:E.jsx(I$,{refreshPage:p,posts:t.posts,deletePost:S,showError:m})}),e?a&&E.jsx(E.Fragment,{children:E.jsx(Mn,{path:"/newpost",element:E.jsx(pL,{refreshPage:p,user:t.user.auth.currentUser,showError:m})})}):E.jsx(Mn,{path:"/register",element:E.jsx(mP,{showError:m})}),E.jsx(Mn,{path:"/about",element:E.jsx(B$,{})}),E.jsx(Mn,{path:"*",element:E.jsx(vP,{})})]})]})};function H$(){qR(Le(),W$)}const q$=()=>{};async function W$(t){const e=await Y$();let n;t?n=t:n=null,Ih.createRoot(document.getElementById("root")).render(E.jsx(z$,{user:n,posts:e,authStateChanged:q$,deletePost:K$,refreshPage:X$}))}const K$=async t=>{const e=Zr(),n=wa(e,"posts",t);qD(n).then(()=>{G$(t)}).catch(r=>{console.log(r)})},G$=async t=>{const e=bm(),n=ls(e,`images/${t}`);await Dm(n).then(r=>{r.items.forEach(i=>{Q$(i._location.path_)})})},Q$=async t=>{await oL(ls(bm(),t)).then(()=>{console.log(t+" is deleted!")}).catch(e=>{console.log(e)})};async function Y$(){let t=[];const e=oS(YE(Zr(),"posts"),UD("timestamp","desc"));return(await uS(e)).forEach(r=>{t.push(r.data())}),t}const X$=()=>{const t=setTimeout(()=>{window.location.reload(!0)},150);return()=>clearTimeout(t)},J$=dL();fp(J$);H$();
